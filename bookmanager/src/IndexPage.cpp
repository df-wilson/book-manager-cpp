...
/******************************************************************************
 * Name: getPage
 * Desc: Get the contents of the index.html page as a string.
 ******************************************************************************
 */   
std::string IndexPage::getPage()
{
    return mPage;
}
...
/******************************************************************************
 * Name: createPage
 * Desc: Create the index.html page.
 ******************************************************************************
 */   
void IndexPage::createPage()
{
   Logger::instance().log(Logger::LogLevel::DEBUG, "IndexPage", "createPage - ENTER");
